 ...
 *
 * Agrega tooltip al gráfico. Establecer un atributo de
 * title para cualquier marca. Será reemplazada por un
 * tooltip frente al hover de usuario.
 * */
...
function addTooltips(chart, styles) {
    ...
    // Object.entries(styles).map(([key, value]) => console.log(`${key}: ${value}`));
  
    return chart;
  }
  // Function to position the tooltip
  var hover = (tip, pos, text) => {
